...
/**
 * Splash / main menu drawn on the Enigma console.
 * Returns once the player has selected an option:
 *   1 → Start Game
 *   2 → High Scores
 *   3 → Exit
 */
public class Menu {
    ...
    /** Blocks until the player presses 1, 2, or 3. Returns the chosen option. */
    public int show(enigma.console.Console cn, HighScoreList scores) {
        ...
        if (selection == 2) {
            ...
            // After showing scores, loop back to menu
            selection = 0;
